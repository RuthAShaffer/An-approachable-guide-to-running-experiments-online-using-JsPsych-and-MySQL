...
jsPsych.plugins["button-response-RAS"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.append('<div id="jspsych-button-response-btngroup" class="center-content block-center buttons_css"></div>') /* RAS added class buttons_css so can more easily change buttons css */
    for (var i = 0; i < trial.choices.length; i++) {
